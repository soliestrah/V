  ...
  grid.innerHTML = filtered.map(t => {
    ...
    return `
      <article class="card" data-id="${t.id}">
        ...
        ${t.prix_wishlist ? `<p class="card__desc">${t.prix_wishlist}</p>` : ''}
        ${t.lien_wishlist ? `<a class="card__link" href="${t.lien_wishlist}" target="_blank" rel="noopener">↗ lien</a>` : ''}
        ${t.nature_wishlist ? `<p class="card__temps">⏱ ${t.nature_wishlist}</p>` : ''}
        <div class="card__meta">
          <div class="card__tags">
            ${t.nature_wishlist ? `<span class="card__tag card__tag--nature">${natureObj.label}</span>` : ''}
            ${t.statut_wishlist ? `<span class="card__tag card__tag--statut card__tag--${t.statut_wishlist}">${statutObj.label}</span>` : ''}
          </div>
